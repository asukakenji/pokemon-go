...
var pokemons = [...]*_pokemon{
	...
	&_pokemon{Charmander, p_, 12, 10, t.Fire, t_, 8.5, 0.6, Charmander, 1, 25},                   // 004: Charmander (ヒトカゲ), SD: 200, CP/HP: [(12/10),,,(35/13),,,]
	...
	&_pokemon{Squirtle, p_, -1, -1, t.Water, t_, 9.0, 0.5, Squirtle, 1, 25},                      // 007: Squirtle (ゼニガメ), SD: 800, CP/HP: [,,,(161/34),,,]
	...
	&_pokemon{Caterpie, p_, 10, 10, t.Bug, t_, 2.9, 0.3, Caterpie, 1, 12},                        // 010: Caterpie (キャタピー), SD: 200, CP/HP: [(10/10),,,]
	...
	&_pokemon{Weedle, p_, 10, 10, t.Bug, t.Poison, 3.2, 0.3, Weedle, 1, 12},                      // 013: Weedle (ビードル), SD: 200, CP/HP: [,,,(14/13),(15/14),,,]
	&_pokemon{Kakuna, Weedle, -1, -1, t.Bug, t.Poison, 10.0, 0.6, Weedle, 1, 50},                 // 014: Kakuna (コクーン), SD: 600, CP/HP: [,,,(64/34),(69/36),,,]
	&_pokemon{Beedrill, Kakuna, -1, -1, t.Bug, t.Poison, 29.5, 1.0, Weedle, 1, 0},                // 015: Beedrill (スピアー), SD: 800, CP/HP: [,,,(240/50),(258/52),,,]
	&_pokemon{Pidgey, p_, 10, 10, t.Normal, t.Flying, 1.8, 0.3, Pidgey, 1, 12},                   // 016: Pidgey (ポッポ), SD: 10:200 / 39:400 / 75:600 / 108:800 / 139:1000 (LV > 8?), CP/HP: [(10/10),(15/11),(25/14),(30/16),(39/18),(46/19),(54/21),(61/22),(75/24),(77/25),(85/26),(92/28),(100/29),(108/30),(116/31),(124/32),(131/33),(139/34),,,]
	&_pokemon{Pidgeotto, Pidgey, 15, 12, t.Normal, t.Flying, 30.0, 1.1, Pidgey, 1, 50},           // 017: Pidgeotto (ピジョン), SD: 15:200 / 117:400, CP/HP: [(15/12),,,(110/32),(125/34),,,]
	&_pokemon{Pidgeot, Pidgeotto, -1, -1, t.Normal, t.Flying, 39.5, 1.5, Pidgey, 1, 0},           // 018: Pidgeot (ピジョット), SD: 234:400 / 263:600, CP/HP:[,,,(204/44),(234/47),(263/50),,,(352/58),,,]
	&_pokemon{Rattata, p_, -1, -1, t.Normal, t_, 3.5, 0.3, Rattata, 1, 25},                       // 019: Rattata (コラッタ), SD: 200, CP/HP: [,,,(21/11),,,]
	&_pokemon{Raticate, Rattata, -1, -1, t.Normal, t_, 18.5, 0.7, Rattata, 1, 0},                 // 020: Raticate (ラッタ), SD: 800, CP/HP: [,,,(296/43),,,]
	&_pokemon{Spearow, p_, 10, 10, t.Normal, t.Flying, 2.0, 0.3, Spearow, 1, 50},                 // 021: Spearow (オニスズメ), SD: 10:200 / 400, CP/HP: [(10/10),,,(63/24),,,]
	&_pokemon{Fearow, Spearow, -1, -1, t.Normal, t.Flying, 38.0, 1.2, Spearow, 1, 0},             // 022: Fearow (オニドリル)
	&_pokemon{Ekans, p_, 10, 10, t.Poison, t_, 6.9, 2.0, Ekans, 1, 50},                           // 023: Ekans (アーボ)
	&_pokemon{Arbok, Ekans, -1, -1, t.Poison, t_, 65.0, 3.5, Ekans, 1, 0},                        // 024: Arbok (アーボック)
	&_pokemon{Pikachu, p_, 11, 10, t.Electric, t_, 6.0, 0.4, Pikachu, 1, 50},                     // 025: Pikachu (ピカチュウ), 172 -> 025, SD: 200, CP/HP: [(11/10),,,]
	&_pokemon{Raichu, Pikachu, -1, -1, t.Electric, t_, 30.0, 0.8, Pikachu, 1, 0},                 // 026: Raichu (ライチュウ)
	&_pokemon{Sandshrew, p_, 10, 10, t.Ground, t_, 12.0, 0.6, Sandshrew, 1, 50},                  // 027: Sandshrew (サンド)
	&_pokemon{Sandslash, Sandshrew, -1, -1, t.Ground, t_, 29.5, 1.0, Sandshrew, 1, 0},            // 028: Sandslash (サンドパン)
	&_pokemon{Nidoran_female, p_, 10, 11, t.Poison, t_, 7.0, 0.4, Nidoran_female, 1, 25},         // 029: Nidoran♀ (ニドラン♀)
	...
	&_pokemon{Jigglypuff, p_, -1, -1, t.Normal, t.Fairy, 5.5, 0.5, Jigglypuff, 1, 50},            // 039: Jigglypuff (プリン), 174 -> 039, SD: 600, CP/HP: [,,,(110/69),,,]
	&_pokemon{Wigglytuff, Jigglypuff, -1, -1, t.Normal, t.Fairy, 12.0, 1.0, Jigglypuff, 1, 0},    // 040: Wigglytuff (プクリン)
	&_pokemon{Zubat, p_, 10, 10, t.Poison, t.Flying, 7.5, 0.8, Zubat, 1, 50},                     // 041: Zubat (ズバット)
	&_pokemon{Golbat, Zubat, 25, 15, t.Poison, t.Flying, 55.0, 1.6, Zubat, 1, 0},                 // 042: Golbat (ゴルバット)
	&_pokemon{Oddish, p_, 13, 10, t.Grass, t.Poison, 5.4, 0.5, Oddish, 1, 25},                    // 043: Oddish (ナゾノクサ), SD: 200, CP/HP: [(13/10),,,]
	...
	&_pokemon{Diglett, p_, 10, 10, t.Ground, t_, 0.8, 0.2, Diglett, 1, 50},                       // 050: Diglett (ディグダ)
	...
	&_pokemon{Poliwag, p_, 10, 10, t.Water, t_, 12.4, 0.6, Poliwag, 1, 25},                       // 060: Poliwag (ニョロモ)
	...
	&_pokemon{Abra, p_, -1, -1, t.Psychic, t_, 19.5, 0.9, Abra, 1, 25},                           // 063: Abra (ケーシィ), SD: 400, CP/HP: [,,,(54/13),,,]
	...
	&_pokemon{Bellsprout, p_, -1, -1, t.Grass, t.Poison, 4.0, 0.7, Bellsprout, 1, 25},            // 069: Bellsprout (マダツボミ), SD: 400, CP/HP: [,,,(104/28),,,]
	...
	&_pokemon{Slowpoke, p_, 15, 17, t.Water, t.Psychic, 36.0, 1.2, Slowpoke, 1, 50},              // 079: Slowpoke (ヤドン)
	&_pokemon{Slowbro, Slowpoke, 34, 19, t.Water, t.Psychic, 78.5, 1.6, Slowpoke, 1, 0},          // 080: Slowbro (ヤドラン)
	&_pokemon{Magnemite, p_, -1, -1, t.Electric, t.Steel, 6.0, 0.3, Magnemite, 1, 50},            // 081: Magnemite (コイル), SD: 200, CP/HP: [,,,(38/10),,,]
	...
	&_pokemon{Koffing, p_, -1, -1, t.Poison, t_, 1.0, 0.6, Koffing, 1, 50},                       // 109: Koffing (ドガース), SD: 600, CP/HP: [,,,(143/23),,,]
	...
	&_pokemon{Horsea, p_, -1, -1, t.Water, t_, 8.0, 0.4, Horsea, 1, 50},                          // 116: Horsea (タッツー), SD: 600, CP/HP: [,,,(93/20),,,]
	...
	&_pokemon{Staryu, p_, 12, 10, t.Water, t_, 34.5, 0.8, Staryu, 1, 50},                         // 120: Staryu (ヒトデマン), SD: 11:200 / 60:400, CP/HP: [(11/10),,,(60/15),,,]
	...
	&_pokemon{Magikarp, p_, 10, 10, t.Water, t_, 10.0, 0.9, Magikarp, 1, 400},                    // 129: Magikarp (コイキング)
	...
	&_pokemon{Eevee, p_, 14, 11, t.Normal, t_, 6.5, 0.3, Eevee, 1, 25},                           // 133: Eevee (イーブイ)
	...
	&_pokemon{Dratini, p_, -1, -1, t.Dragon, t_, 3.3, 1.8, Dratini, 1, 25},                       // 147: Dratini (ミニリュウ) SD: 64:400 / 172:800, CP/HP: [,,,(64/20),,,(172/33),,,]
